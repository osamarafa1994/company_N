            ...
            <nav class="navbar navbar-static-top">
               ...
               <div class="navbar-custom-menu">
                  <ul class="nav navbar-nav">
                     ...
                     <!-- user -->
                     <li class="dropdown dropdown-user" style="margin-right: 550px;">
                        <a href="#" class="dropdown-toggle pull-left" data-toggle="dropdown">{{ Auth::user()->name }}
                        <img src="{{ asset('img/avatar5.png') }}" class="img-circle" width="45" height="45" alt="user"></a>
                        <ul class="dropdown-menu" >
                           <li >
                              <a href="{{ asset('dash') }}">
                              <i class="fa fa-user"></i> الصفحة الشخصيه</a>
                           </li>
                           <li><a href="#"><i class="fa fa-inbox"></i> رسالتي</a></li>
                           <li>
