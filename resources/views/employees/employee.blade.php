         ...
         <div class="col-sm-12">
            <div class="panel panel-bd lobidrag">
               ...
               <div class="panel-body">
                 ...
                 <a href="#" class="btn btn-add" data-toggle="modal" data-target="#adduser"><i class="fa fa-user"></i> اٍضافة موظف </a>
                 <!-- Add Model -->
                   ...
                   <div class="modal-dialog">
                      <div class="modal-content">
                         <div class="modal-header modal-header-primary">
                            ...
                            <h3><i class="fa fa-plus m-r-5"></i> اضافة موظف جديد </h3>
                         </div>
                                 ...
                                 <form action="{{asset('employee')}}" method="post">
                                     ...
                                     <fieldset>
                                        ...
                                        <div class="col-md-6 form-group">
                                           ...
                                           <input type="text" name="name" placeholder="اسم الموظف" required class="form-control">
                                        </div>


                                          <!-- Text input-->
                                          <div class="col-md-6 form-group">
                                             <label class="control-label">الدور الوظيفي</label>
                                          ...
                                          <!-- Text input-->
                                          <div class="col-md-6 form-group">
                                             <label class="control-label">اختار الشركه </label>
                                             <select class="form-control" name="company_id" required>

                                                  <option value="0">متحكم في النظام </option>
                  ...
                  <div class="table-responsive">
                     <table id="Example1" class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td colspan="4"><div class="alert alert-danger fade in">
                          ...
                          @elseif(isset($employees) && !empty($employees))
                              <?php $x=1; ?>
                               ...
                               <tr>
                                  ...
                                  <td>
                                    <a href="{{asset('employee/'.$employee->id).'/edit'}}" class="btn btn-success btn-sm">
                                        <i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                    <button type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#delete{{$employee->id}}"><i class="fa fa-trash-o"></i> </button>
                                  </td>
...
@foreach($employees as $employee)
<!-- delete user Modal2 -->
<div class="modal fade" id="delete{{$employee->id}}" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog">
     <div class="modal-content">
        <div class="modal-header modal-header-primary">
           <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
        ...
        <div class="modal-body">
           <div class="row">
              <div class="col-md-12">
                 <form method="post" action="{{asset('employee/'.$employee->id)}}" class="form-horizontal">
                    <fieldset>
                       <div class="col-md-12 form-group user-form-group">
