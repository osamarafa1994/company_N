                      ...
                      <form action="{{asset('employee/'.$employee->id)}}" method="post">
                          ...
                          <fieldset>
                             ...
                             <div class="col-md-6 form-group">
                                ...
                                <input type="text" name="name" value="{{$employee->name}}" placeholder="اسم الشركة" required class="form-control">
                             </div>
                             <div class="col-md-6 form-group">
                                <label class="control-label">رقم التليفون</label>
                                <input type="text" name="phone" value="{{$employee->phone}}" placeholder="رقم التليفون" class="form-control" required>
                             </div>
                             <!-- Text input-->
                             <div class="col-md-6 form-group">
                                <label class="control-label">البريد الالكتروني</label>
                                <input type="email" name="email" value="{{$employee->email}}" placeholder="البريد الالكتروني" class="form-control" required>
                             </div>
                             <div class="col-md-6 form-group">
                                <label class="control-label">العنوان</label>
                                <input type="text" name="address" value="{{$employee->address}}" placeholder="العنوان" class="form-control" required>
                             </div>
